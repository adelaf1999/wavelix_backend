...
ActiveRecord::Schema.define(version: 2021_02_02_113739) do
  ...
  create_table "admins", force: :cascade do |t|
    ...
    t.datetime "renew_verification_code_at", null: false
  ...
  create_table "blocked_reasons", force: :cascade do |t|
    t.string "admin_name", null: false
    t.string "reason", null: false
    t.integer "profile_id", null: false
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "customer_users", force: :cascade do |t|
    ...
    t.string "apartment_floor", default: ""
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string "driver_payment_intent"
  end
  ...
  create_table "post_cases", force: :cascade do |t|
    t.integer "post_id", null: false
    t.integer "review_status", default: 0
    t.text "admins_reviewed", default: [], array: true
    t.string "deleted_by", default: ""
    t.text "admins_reviewing", default: [], array: true
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "post_author_id", null: false
    t.string "post_author_username", null: false
  end
